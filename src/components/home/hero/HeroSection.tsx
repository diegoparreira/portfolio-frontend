      ...
      <Row className="hero-content">
        <Col xs={12} md={9} className="hero-text-col">
          ...
          <p className="hero-description">
            Me chamo Diego Parreira e sou arquiteto de software, desenvolvedor e apaixonado por
            tecnologia e o seu poder de transformação!
          </p>
        </Col>
        <Col xs={12} md={3} className="hero-avatar-col">
          <Image
            ...
            roundedCircle
            fluid
            className="border border-3 border-light shadow-sm mb-4"
          />
        </Col>
