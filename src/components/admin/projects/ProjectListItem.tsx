...
const ProjectListItem: React.FC<ProjectListItemProps> = ({ project, onEdit, onFavoriteToggle }) => {
  return (
    <ListItem onClick={onEdit}>
      <FavoriteStar value={project.favorite || false} onToggle={onFavoriteToggle} />
